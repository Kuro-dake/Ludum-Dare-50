...
public class MakeTransitions : MonoBehaviour
{
    ...
    public List<MakeTransitionData> transitions;
    public List<MakeTransitionData> filtered_transitions;
    public List<Pair<string, Pair<GameObject, float>>> group_targets;
    ...
    public List<MakeTransitionData> this[string s]=>GetFilteredTransitions(s);
